...
public class PrintHeapDemo {
    /**
     * Prints out a vey basic drawing of the given array of Objects assuming it is a heap starting at
     * index 1. You're welcome to copy and paste code from this method into your code, just make sure
     * to cite this with the @source tag.
     */
    ...
    /**
     * Prints out a drawing of the given array of Objects assuming it is a heap starting at index 1.
     * You're welcome to copy and paste code from this method into your code, just make sure to cite
